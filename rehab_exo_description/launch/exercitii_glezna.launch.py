#!/usr/bin/env python3
"""
exercitii_glezna.launch.py — Sesiunea de GLEZNA: pump + alternat + mentineri (57 s)
Ruleaza intreaga sesiune (RViz + controler) dintr-o singura comanda:
    $ ros2 launch rehab_exo_description exercitii_glezna.launch.py
    $ ros2 launch rehab_exo_description exercitii_glezna.launch.py reps:=2   # repeta sesiunea de 2 ori
"""
