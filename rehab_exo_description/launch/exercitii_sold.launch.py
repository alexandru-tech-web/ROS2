#!/usr/bin/env python3
"""
exercitii_sold.launch.py — Sesiunea de SOLD: ridicari + alternat + izometrie (49 s)
Ruleaza intreaga sesiune (RViz + controler) dintr-o singura comanda:
    $ ros2 launch rehab_exo_description exercitii_sold.launch.py
    $ ros2 launch rehab_exo_description exercitii_sold.launch.py reps:=2   # repeta sesiunea de 2 ori
"""
