...
ETA_IMPLICIT = 0.80
# Turatia de mers in gol a TBM-6025 la 48 V. NU e in partea citita a foii de catalog.
RPM_GLEZNA_IMPLICIT = 1500.0
...
def tabel(eta=ETA_IMPLICIT, rpm_glezna=RPM_GLEZNA_IMPLICIT):
    out = []
...
def _selftest():
    ...
    v += ok(viteza_nominala_rad_s("glezna", 1500.0)
            != viteza_nominala_rad_s("glezna", 3000.0),
            "viteza gleznei trebuie sa depinda de ipoteza de rpm")
