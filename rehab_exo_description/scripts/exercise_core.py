...
def _full_hip_raise(reps=3):
    rep = [
        (2.0, _both({"hip": 1.2976})),
        (1.5, {}),
        (2.0, _both({"hip": 0.6147})),
        (1.0, {}),
    ]
    return rep * reps
...
def _full_hip_alternating(reps=2):
    rep = [
        (1.8, {"left_hip_joint": 1.3659}),
        (0.8, {}),
        (1.8, {"left_hip_joint": 0.6147}),
        (1.8, {"right_hip_joint": 1.3659}),
        (0.8, {}),
        (1.8, {"right_hip_joint": 0.6147}),
        (0.4, {}),
    ]
    return rep * reps
...
def _full_hip_hold(reps=2):
    rep = [
        (2.2, _both({"hip": 1.4342})),
        (4.0, {}),                          # mentinere izometrica
        (2.2, _both({"hip": 0.6147})),
        (0.6, {}),
    ]
    return rep * reps
...
def _full_alternating_march(reps=3):
    rep = [
        (1.6, {"left_hip_joint": 1.2293, "left_knee_joint": 1.2208}),
        (1.6, {"left_hip_joint": 0.6147, "left_knee_joint": 1.5708}),
        (1.6, {"right_hip_joint": 1.2293, "right_knee_joint": 1.2208}),
        (1.6, {"right_hip_joint": 0.6147, "right_knee_joint": 1.5708}),
    ]
    return rep * reps

def _full_full_extension(reps=2):
    rep = [
        (3.0, _both({"hip": 0.9561, "knee": 0.0708, "ankle": 0.15})),
        (2.5, {}),
        (3.0, _both({"hip": 0.6147, "knee": 1.5708, "ankle": 0.00})),
        (1.0, {}),
    ]
    return rep * reps
